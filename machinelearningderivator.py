...
if len(sys.argv) == 5:
    ...
    X_train, X_validation = train_test_split(retrievedData['count'], test_size=0.20, random_state=1)
    ...
    for name, model in models:
        ...
        cv_results = cross_val_score(model, X_train, cv=kfold, scoring='accuracy')
